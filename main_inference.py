...
def get_args_parser():
    ...
    parser.add_argument("--use_torch_compile", action="store_true", help="Enable torch.compile for faster training/inference")
    parser.add_argument("--use_multiscale_tta", action="store_true", help="Enable multi-scale test-time augmentation")
    parser.add_argument("--tta_scales", nargs="+", type=float, default=[0.75, 1.0, 1.25], help="Scales for multi-scale TTA")
    parser.add_argument("--tta_nms_threshold", type=float, default=0.5, help="NMS IoU threshold for TTA box merging")
    return parser
